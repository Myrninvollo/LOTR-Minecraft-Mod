...
public class LOTRModelMug extends ModelBase
{
	...
	public LOTRModelMug()
	{
		...
		mugParts[0].addBox(-3F, -8F, -2F, 1, 8, 4);
		
		mugParts[1] = new ModelRenderer(this, 10, 3);
		mugParts[1].addBox(-3F, -8F, -3F, 6, 8, 1);
		
		mugParts[2] = new ModelRenderer(this, 24, 0);
		mugParts[2].addBox(2F, -8F, -2F, 1, 8, 4);
		
		mugParts[3] = new ModelRenderer(this, 34, 3);
		mugParts[3].addBox(-3F, -8F, 2F, 6, 8, 1);
		
		mugParts[4] = new ModelRenderer(this, 0, 12);
		mugParts[4].addBox(-2F, -1F, -2F, 4, 1, 4);
		
		handleParts[0] = new ModelRenderer(this, 0, 17);
		handleParts[0].addBox(3F, -7F, -0.5F, 2, 1, 1);
		
		handleParts[1] = new ModelRenderer(this, 0, 19);
		handleParts[1].addBox(4F, -6F, -0.5F, 1, 4, 1);
		
		handleParts[2] = new ModelRenderer(this, 0, 24);
		handleParts[2].addBox(3F, -2F, -0.5F, 2, 1, 1);
	}
	
	@Override
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		for (int i = 0; i < mugParts.length; i++)
		{
			mugParts[i].render(f5);
		}
		for (int i = 0; i < handleParts.length; i++)
		{
			handleParts[i].render(f5);
		}
	}
}
