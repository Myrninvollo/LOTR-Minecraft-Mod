...
public class LOTRBlockBrick extends Block
{
	@SideOnly(Side.CLIENT)
	private IIcon[] brickIcons;
	private String[] brickNames = {"mordor", "gondor", "gondorMossy", "gondorCracked", "rohan", "gondorRuins", "dwarven", "mordorCracked", "dwarvenSilver", "dwarvenGold", "dwarvenMithril", "elven", "elvenMossy", "elvenCracked", "blueRock", "nearHarad"};
