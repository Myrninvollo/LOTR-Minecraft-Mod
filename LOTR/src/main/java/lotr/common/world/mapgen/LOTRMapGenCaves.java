...
public class LOTRMapGenCaves extends MapGenBase
{
                    ...
                    for (var42 = var55; !var58 && var42 < var36; ++var42)
                    {
                        for (int var43 = var56; !var58 && var43 < var40; ++var43)
                        {
                            for (int var44 = var38 + 1; !var58 && var44 >= var57 - 1; --var44)
                            {
                                ...
                                {
                                    if (par5ArrayOfByte[var45] == Blocks.flowing_water || par5ArrayOfByte[var45] == Blocks.water)
                                    {
                                        var58 = true;
                                    }
                            ...
                            for (var45 = var56; var45 < var40; ++var45)
                            {
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D)
                                {
                                    for (int var50 = var38 - 1; var50 >= var57; --var50)
                                    {
                                        ...
                                        {
                                            Block var53 = par5ArrayOfByte[var48];
                                            ...
                                            if (var53 == Blocks.stone || var53 == Blocks.dirt || var53 == Blocks.grass || var53 == LOTRMod.rock)
                                            {
                                                if (var50 < 10)
                                                {
                                                    par5ArrayOfByte[var48] = Blocks.flowing_lava;
                                                }
                                                else
                                                {
                                                    par5ArrayOfByte[var48] = Blocks.air;

                                                    if (var49 && par5ArrayOfByte[var48 - 1] == Blocks.dirt)
                                                    {
    ...
    protected void func_151538_a(World par1World, int par2, int par3, int par4, int par5, Block[] par6ArrayOfByte)
    {
        ...
        {
            double var9 = (double)(par2 * 16 + rand.nextInt(16));
            double var11 = (double)rand.nextInt(rand.nextInt(120) + 8);
            double var13 = (double)(par3 * 16 + rand.nextInt(16));
            int var15 = 1;
