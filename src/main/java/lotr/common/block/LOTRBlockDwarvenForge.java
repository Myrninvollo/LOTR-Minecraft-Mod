...
public class LOTRBlockDwarvenForge extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entity, ItemStack itemstack)
    {
        ...
        {
            ((LOTRTileEntityDwarvenForge)world.getTileEntity(i, j, k)).setSpecialForgeName(itemstack.getDisplayName());
        }
    }
    ...
    {
		LOTRTileEntityDwarvenForge forge = (LOTRTileEntityDwarvenForge)world.getTileEntity(i, j, k);
		if (forge != null)
		{
